...
export default function Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[var(--white)] px-5 pt-20 select-none dark:bg-[var(--dark-bg-primary)]">
      <div className="w-full max-w-md">
        ...
        <form className="mt-[35px] space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="my-6 space-y-6">
            <Button
              type="submit"
              className="h-[56px] bg-[var(--primary-yellow)] text-[16px] font-bold"
            >
              로그인
            </Button>
            ...
            <div className="flex flex-col gap-3">
              <Button
                type="button"
                className="gap-2 border border-[var(--gray-300)] bg-[var(--white)] text-black dark:bg-[var(--dark-bg-primary)]"
        ...
        <div className="flex justify-center gap-6 text-sm text-[var(--gray-600)]">
          <a
