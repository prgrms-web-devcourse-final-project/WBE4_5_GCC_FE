...
import { EditModeProvider, useEditMode } from "@/app/components/routine/EditModeContext";
...
function Header() {
  ...
  return (
    <header className="relative flex justify-between items-center w-full px-3 py-4 border-b border-[#CCCCCC]">
      ...
      <div className="flex gap-[7px] text-sm text-[#616161]">
        <button onClick={handleAddCat} className="cursor-pointer">추가</button>
