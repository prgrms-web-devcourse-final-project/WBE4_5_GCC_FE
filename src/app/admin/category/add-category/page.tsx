            ...
            <div className="flex flex-col gap-7 px-5 py-7">
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="flex h-[45px] min-w-[45px] items-center justify-center rounded-lg border border-[var(--gray-300)]"
                >
                  {selectedEmoji ? (
                ...
                {/* 우측 인풋 영역 */}
                <div className="flex w-full min-w-70 border border-transparent border-b-[var(--gray-300)] py-2 text-xl text-black">
                  <input
                    type="text"
                    value={categoryName}
