  ...
  return (
    ...
    >
      ...
      {item.status === 'LOCKED' && !action && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center rounded-[5px] bg-[#222222] dark:bg-[var(--dark-gray-200)]/85">
          <Image
            src="/images/lock.svg"
            alt="잠금아이콘"
            width={79}
          ...
          <button className="relative mt-4 h-7.5 min-w-34 overflow-hidden rounded-[3px] border border-[#ffb84c] bg-white text-sm font-semibold text-[#A47148] dark:bg-[var(--dark-bg-primary)]">
            {/* 채워진 배경 */}
            <div
      ...
      <div>
        ...
        >
          ...
          <div
            className={`text-[10px] ${item.isLocked ? 'text-[#515151]' : 'text-[#616161] dark:text-[var(--dark-gray-300)]'}`}
          >
            {item.info}
          </div>
            ...
            {action ? (
              ...
              <button
                ...
                className={clsx(
                  ...
                  isSelected
                    ? 'border-[#ffb84c] bg-[#ffb84c] font-semibold text-white dark:text-[var(--dark-bg-primary)]'
