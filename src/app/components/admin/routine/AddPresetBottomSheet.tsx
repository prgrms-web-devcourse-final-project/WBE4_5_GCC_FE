...
export default function AddPresetBottomSheet({
  ...
  return (
    ...
    >
      <div
        className="w-full rounded-t-[24px] bg-white px-4 pt-8 pb-16 dark:bg-[var(--dark-bg-primary)]"
      ...
      >
        ...
        <button
          onClick={handleSave}
          className="w-full rounded-lg bg-[#ffb84c] py-3 font-medium text-white dark:text-[var(--dark-bg-primary)]"
        >
          저장
        </button>
      </div>
