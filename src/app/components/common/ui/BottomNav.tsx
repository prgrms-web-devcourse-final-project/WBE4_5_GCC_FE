...
export default function BottomNav() {
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 border-t border-[#e0e0e0] bg-white shadow-md dark:border-t-[var(--dark-bg-secondary)] dark:bg-[var(--dark-bg-primary)]">
      <ul className="mx-auto flex max-w-md justify-between px-6 py-3">
        <li>
          ...
          >
            <List size={24} />
            <span className="mt-1 text-xs dark:text-[var(--dark-gray-700)]">
              루틴
            </span>
          </Link>
        </li>
