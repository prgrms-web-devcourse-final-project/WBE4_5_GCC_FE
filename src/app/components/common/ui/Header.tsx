...
export default function Header() {
  ...
  return (
    <>
      <div className="z-50 mx-auto flex h-[56px] max-w-md items-center justify-between bg-white px-5 py-[20px] dark:border-[var(--dark-bg-tertiary)] dark:bg-[var(--dark-bg-primary)]">
        {isHome || isAdmin ? (
          <Image
            src={logo}
            alt="logo"
