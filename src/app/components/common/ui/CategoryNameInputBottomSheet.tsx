...
export default function CategoryNameInputBottomSheet({
  ...
  return (
    ...
    >
      <div
        className="min-h-[443px] w-[614px] rounded-t-[24px] bg-white px-3 py-6 dark:bg-[var(--dark-bg-primary)]"
      ...
      >
        ...
        <div className="flex justify-between text-[#222222] dark:text-[var(--dark-gray-700)]">
          ...
          <p className="text-xl font-semibold">카테고리 이름을 입력하세요</p>
          <button onClick={handleSubmit} className="cursor-pointer text-base font-medium">
            확인
          </button>
        </div>
        {/* 인풋창 */}
        <div className="mt-[40px] flex h-[62px] min-w-[354px] justify-start rounded-lg border border-[#222222] px-4 py-5">
          <input
            type="text"
            placeholder="ex.식비"
            value={subCatName}
