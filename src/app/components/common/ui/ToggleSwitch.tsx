...
export default function ToggleSwitch({
  ...
  return (
    <div
      className={`flex h-16 w-full max-w-[614px] items-center justify-between rounded-b-lg border border-[#E0E0E0] px-5 py-4 dark:border-[var(--dark-bg-tertiary)] dark:bg-[var(--dark-bg-primary)] ${className ?? ''
        }`}
    >
      {/* 좌측 영역 */}
