...
export default function CalendarBottomSheet({
  ...
  return (
    ...
    >
      <div
        className="relative h-[500px] w-full max-w-md rounded-t-2xl bg-[var(--white)] px-4 py-6 dark:bg-[var(--dark-bg-primary)]"
      ...
      >
        ...
        <Calendar
          ...
          className="w-full bg-[var(--white)] px-2 text-sm dark:bg-[var(--dark-bg-primary)]"
