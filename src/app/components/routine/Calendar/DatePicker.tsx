  ...
  return (
    <div className="relative w-[100px] text-xs" ref={ref}>
      <input
        type="text"
        value={displayDate}
        className={`focus-primary body1 w-full cursor-pointer rounded-[10px] px-2 py-1 text-center hover:shadow-sm focus:border-transparent focus:ring-0 focus:outline-none ${hasUserSelected ? 'text-[var(--black)] dark:text-[var(--dark-gray-700)]' : 'text-[var(--gray-500)]'}`}
        readOnly
