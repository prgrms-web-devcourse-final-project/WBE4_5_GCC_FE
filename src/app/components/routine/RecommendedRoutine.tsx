        ...
        <div className="routine-scroll flex gap-2 overflow-x-auto">
          {routines.map((routine, index) => (
            <button
              ...
              className="font-regular shrink-0 cursor-pointer rounded-lg border border-[#e0e0e0] px-4 py-2 text-sm whitespace-nowrap text-[#616161] hover:bg-[#FFB84C] hover:text-white dark:text-[var(--dark-gray-700)]"
            >
              {routine.name}
            </button>
          ))}
