        ...
        return (
          <div key={idx} className="flex w-full justify-center">
            <button
              ...
              className={`relative flex w-full max-w-[92px] flex-col items-center gap-1 py-2.5 text-sm text-[var(--black)] dark:text-[var(--dark-gray-700)] ${
            ...
            >
              ...
              {/*{isEditMode && cat.categoryType === 'MAJOR' && (
                <div className="absolute top-1 right-4 z-20 p-1">
                  <CircleX
                    className="h-auto w-[15px] fill-[var(--gray-300)] text-[var(--gray-700)]"
                    onClick={(e) => {
                      e.stopPropagation();
              ...
              <div className="flex aspect-square w-[50px] items-center justify-center rounded-full bg-[var(--gray-100)] dark:bg-[var(--dark-gray-700)]">
                {cat.emoji}
              </div>
